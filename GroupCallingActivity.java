...
public class GroupCallingActivity extends AppCompatActivity {
    ...
    private RecyclerView contactcards;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactcards = findViewById(R.id.contact_list);

        mediaPlayer= MediaPlayer.create(this,R.raw.ringing);

        nameContact = findViewById(R.id.group_name_calling);
        profileImage = findViewById(R.id.group_profile_image_calling);
        cancelCallBtn = findViewById(R.id.group_cancel_call);
        acceptCallBtn = findViewById(R.id.group_make_call);
                ...
                userRef.child(senderUserId).child("Ringing").updateChildren(callingPickUpMap)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    Intent intent = new Intent(GroupCallingActivity.this,VideoChatActivity.class);
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                userRef.child(senderUserId).child("Calling").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        startActivity(new Intent(GroupCallingActivity.this, Registration.class));
                                        finish();
                                    }
                                });
                            }
